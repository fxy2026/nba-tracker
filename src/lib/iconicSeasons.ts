...
export const ICONIC_SEASONS: IconicSeason[] = [
  ...
  { id: "203999-2022", personId: 203999, name: "Nikola Jokić", season: "2022-23", seasonYear: 2022, team: "DEN",
    ...
    styles: ["playmaking-big", "post-scorer", "elite-passer"],
    story: "Championship + Finals MVP. The playoff run included a 5-game sweep of LeBron's Lakers in the WCF.",
    storyZh: "夺冠 + 总决赛 MVP。西决 4-0 横扫詹姆斯领衔的湖人。",
    champion: true, finalsMvp: true },
  { id: "203999-2023", personId: 203999, name: "Nikola Jokić", season: "2023-24", seasonYear: 2023, team: "DEN",
    ppg: 26.4, rpg: 12.4, apg: 9.0, spg: 1.4, bpg: 0.9, fgPct: 0.583,
    playoffPpg: 28.5, playoffRpg: 12.4, playoffApg: 9.5, playoffGp: 12,
    styles: ["playmaking-big", "post-scorer", "elite-passer"],
    story: "Third MVP in four years. Cemented his place in the all-time pantheon of big men.",
    storyZh: "四年三 MVP。坐稳历史顶级内线席位。",
    mvp: true },
  { id: "1629029-2023", personId: 1629029, name: "Luka Dončić", season: "2023-24", seasonYear: 2023, team: "DAL",
    ppg: 33.9, rpg: 9.2, apg: 9.8, spg: 1.4, fgPct: 0.487, tpPct: 0.382,
    playoffPpg: 28.9, playoffRpg: 9.5, playoffApg: 8.1, playoffGp: 22,
    styles: ["iso-creator", "high-usage-scorer", "elite-passer"],
    story: "Scoring title and a Finals run that ended against Boston. 25-year-old Luka entered superstar tier.",
    storyZh: "得分王 + 总决赛之旅（最终不敌凯尔特人）。25 岁的卢卡晋级超级巨星行列。",
    scoringTitle: true },
  { id: "1628983-2024", personId: 1628983, name: "Shai Gilgeous-Alexander", season: "2024-25", seasonYear: 2024, team: "OKC",
    ppg: 32.7, rpg: 5.0, apg: 6.4, spg: 1.7, fgPct: 0.519, tpPct: 0.375, ftPct: 0.898,
    playoffPpg: 30.3, playoffRpg: 5.5, playoffApg: 6.4, playoffGp: 23,
    styles: ["iso-creator", "high-usage-scorer", "lockdown-defender"],
    story: "MVP + scoring title + Finals MVP. Led OKC to the 2025 championship — first ever for the franchise's OKC era.",
    storyZh: "MVP + 得分王 + FMVP。带领雷霆赢得 2025 总冠军——OKC 时代的首座。",
    mvp: true, champion: true, finalsMvp: true, scoringTitle: true },
];
