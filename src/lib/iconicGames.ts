...
export const ICONIC_GAMES: IconicGame[] = [
  ...
  },
  {
    ...
    finalScore: "87-86",
    homeAway: "away",
    pts: 45, reb: 1, ast: 1, stl: 4,
    fg: "15/35", threeP: "3/7", ft: "12/15", minutes: 44,
    title: "The Last Shot",
    titleZh: "最后一投",
  ...
  },
  {
    ...
    finalScore: "118-115",
    homeAway: "home",
    pts: 50, reb: 7, ast: 6, stl: 3, blk: 1,
    fg: "17/33", threeP: "10/18", ft: "6/8", minutes: 45,
    title: "Dame Time — the 37-foot series winner",
    titleZh: "Dame Time —— 37 英尺压哨绝杀",
    story: "Game 5, first round vs OKC. Lillard capped a 50-point night with a 37-foot buzzer-beater over Paul George to end the series — then waved the Thunder goodbye.",
    storyZh: "首轮 G5 对雷霆。利拉德狂砍 50 分，终场前在保罗·乔治面前命中 37 英尺压哨三分淘汰对手——随后向雷霆替补席挥手告别。",
    tags: ["playoff", "buzzer-beater", "clutch", "scoring-record"],
  },
  {
    id: "dame-71",
    personId: 203081,
