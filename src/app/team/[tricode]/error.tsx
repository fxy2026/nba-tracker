...
export default function TeamError({
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12" role="alert">
      <Link href="/standings" className="text-[11px] font-mono uppercase tracking-[0.2em] text-text-secondary hover:text-accent transition-colors cursor-pointer">
        ← {isZh ? "返回排名" : "Back to standings"}
      </Link>
      <div className="glass-tile mt-4 p-10 sm:p-12 text-center">
        ...
        <h2 className="text-xl font-semibold tracking-tight text-text-primary">{isZh ? "球队数据加载失败" : "Couldn't load team"}</h2>
